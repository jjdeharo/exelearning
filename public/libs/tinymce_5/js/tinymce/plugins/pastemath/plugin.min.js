...
tinymce.PluginManager.add('pastemath', function (editor, url) {
    ...
    function setGeneralAttribsAndHide() {
        ...
        labelB.html(labelB.html().replace("eXeMathEditor", "<a href='#' onclick='PasteMathDialog.mathEditor.start();return false' style='text-decoration:underline;cursor:pointer'>fMath</a>").replace("(LaTeX...)", "(" + PasteMathDialog.acceptedLanguages + ")"));
    ...
    function setHelpAttribs() {
        ...
        tabB.html(tabB.html().replace("eXeMathEditor", "<a href='#' onclick='PasteMathDialog.mathEditor.start();return false' style='text-decoration:underline;cursor:pointer'>fMath</a>").replace("(LaTeX...)", "(" + PasteMathDialog.acceptedLanguages + ")"));
    }
    ...
    PasteMathDialog = {
        ...
        mathEditor: {
            ...
            start: function () {
                ...
                var mypage = "app/common/fMath/index.html";
