...
(function () {
  ...
  function setLinkCss() {
    let iframe = document.getElementsByClassName("tox-dialog")[0].querySelector("iframe");
    let head = iframe.contentWindow.document.getElementsByTagName('head')[0];
    let newLink = document.createElement("link");
    newLink.rel = 'stylesheet';
    newLink.type = "text/css";
    newLink.href = myUrl + '/css/content.css';
  ...
  var register = function (editor) {
    ...
    editor.on('init', function (e) {
      editor.dom.loadCSS(myUrl + "/css/content.css");
    });
  };

  function Plugin() {
    global$4.add('template', function (editor, url) {
      myUrl = url;
      register(editor);
      register$1(editor);
      setup(editor);
