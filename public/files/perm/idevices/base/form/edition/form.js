    ...
    */
    ...
    Msgs: class {
        ...
        setMessagesInfo() {
            ...
            this.strings.msgInstructionsFill = _(`Type or paste the text for the fill-in-the-blank activity into the field. Select the words and use the button below to hide them. You can define more than one possible answer surrounding and separating them by a vertical bar. E.g.: |dog|cat|bird|`);
